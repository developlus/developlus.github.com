...
copyright = '2013-2014, DeveloPlus'

# Change this to your blog root URL (required for RSS feed)
website = 'http://www.developlus.jp/'
...
extensions = ['tinkerer.ext.blog', 'tinkerer.ext.disqus', 'japanesesupport']
...
html_sidebars = {
    '**': ['categories.html', 'tags.html', 'recent.html', 'searchbox.html']
